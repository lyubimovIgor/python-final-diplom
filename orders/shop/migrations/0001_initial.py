    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Контакт', to='auth_api.contact', verbose_name='Контакт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_name', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/Users/romanspiridonov/PycharmProjects/ATOL/Templates/python-final-diplom_VengAniRi/orders/storage'), upload_to='', verbose_name='')),
